...
\begin{table}[h!]
    ...
    \label{table:PR1}
    \begin{tabular}{|c|l|p{0.5\linewidth}|l|}
      \toprule % toprule here
...
As seen from the tables, the precedence found in C++ is facet of the language that allows for great control and maneuverability of the programming language and the code one is able to make. All these in an effor to avoid problems in regards to ambiguity of the language and to isolate certain processes from others. 

\textbf{Operators and their overloads} C++ has a great number of operators existing within the language. The table of precedence rules shows the which among the operators work first 
